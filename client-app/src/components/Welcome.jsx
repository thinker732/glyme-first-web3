...
const Input=({ placeholder, name, type, value, handleChange })=>{
    ...
    className="my-2 w-full rounded-lg p-2 text-center outline-none bg-transparent text-white border-none text-sm white-glassmorphism"
    />
  )
}
...
const Welcome=()=>{
    ...
    return(
        <div className="flex w-full justify-center items-center">
            <div className="flex flex-col md:flex-row flex-col  justify-between items-start md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col md:mr-24">
                    ...
                    (<button
                     ...
                     <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        <div className={`rounded-tl-2xl ${commonStyles}`}> Reability</div>
                        ...
                        <div className={`rounded-bl-2xl md:rounded-none ${commonStyles}`}> Fees Affordable</div>
                     ...
                     <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-start blue-glassmorphism">
                        ...
                        :(
                            <button
                                ...
                                className="w-full text-white mt-2 border-[1px] p-2 border-[#3d4f7c] hover:bg-[#3d4f7c] rounded-full cursor-pointer"
                            >
                                Send now
                            </button>
                        )
